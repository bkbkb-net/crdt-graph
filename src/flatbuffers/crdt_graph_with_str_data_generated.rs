...
impl<'a> AddVertex<'a> {
  ...
  pub fn data(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(AddVertex::VT_DATA, None)}
  }
}
...
impl<'a> AddEdge<'a> {
  ...
  pub fn data(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(AddEdge::VT_DATA, None)}
  }
}
...
pub const OPERATION_LOG_IDENTIFIER: &str = "CRD3";
